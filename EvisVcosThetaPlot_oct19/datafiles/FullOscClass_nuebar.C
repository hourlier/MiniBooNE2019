#define FullOscClass_nuebar_cxx
#include "FullOscClass_nuebar.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void FullOscClass_nuebar::Loop2()
{
...
void FullOscClass_nuebar::Loop()
{
   ...
   Long64_t nentries = fChain->GetEntriesFast();
    ...
    hCosTheta = new TH1D("hCosTheta_FullOsc_nuebar","hCosTheta_FullOsc_nuebar",20,-1,1);
    ...
    ofstream fout("fullosc_nuebar_MC.txt");
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
       fChain->GetEntry(jentry);
